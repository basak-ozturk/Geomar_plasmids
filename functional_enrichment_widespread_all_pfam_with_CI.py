...
plt.xlabel("log$_2$(Odds Ratio)", fontsize=12)
plt.ylabel("PFAM Domain Group", fontsize=12)
plt.title("PFAM Enrichment in Widespread Plasmids\n(log$_2$ Odds Ratio with 95% CI)", fontsize=14)
plt.tight_layout()
plt.legend()
plt.savefig("C:/Users/hayat/Downloads/R_files/graphs/pfam_enrichment_odds_ratio_with_CI.png", dpi=300, bbox_inches="tight")
plt.show()
