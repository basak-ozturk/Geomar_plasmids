...
plt.savefig("C:/Users/hayat/Downloads/R_files/graphs/UMAP_DBSCAN_plot_pathway_std_py_cosine.png", dpi=300, bbox_inches='tight')
plt.show()
...
with open("C:/Users/hayat/Downloads/R_files/data/plasmids_per_cluster_Pathway_std.txt_cosine", "w") as f:
...
plt.savefig("C:/Users/hayat/Downloads/R_files/graphs/UMAP_Host_Color_pathway_cosine.png", dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig("C:/Users/hayat/Downloads/R_files/graphs/UMAP_Facet_Grid_Host_pathway_cosine.png", dpi=300, bbox_inches='tight')
plt.show()
