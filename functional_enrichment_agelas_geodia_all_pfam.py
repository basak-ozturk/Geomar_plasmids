...
plt.figure(figsize=(10, 12))  # Larger height
sns.set(style="whitegrid")

# Plot and prepare y-ticks
y_positions = np.arange(len(significant_filtered))  # Numeric y values
pfam_labels = significant_filtered["PFAMs"]
...
plt.yticks(y_positions, pfam_labels)
...
plt.title(r'PFAM Enrichment in Agelas Plasmids' + '\n' +
          r'$\left(\log_2(\mathrm{Odds\ Ratio\ with\ 95\%\ CI})\right)$>3')
...
output_df = significant_filtered.rename(columns={
