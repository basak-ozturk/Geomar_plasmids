...
# Filter K-numbers that appear in at least 10 plasmids
...
binary_matrix_filtered.to_csv("C:/Users/hayat/Downloads/R_files/data/plasmid_clusters_hierarchical_KEGG_10.csv")
...
plt.title("Hierarchical Clustering Dendrogram Based on Encoded KEGGs")
plt.xlabel("Plasmids")
plt.ylabel("Distance")
plt.savefig("C:/Users/hayat/Downloads/R_files/graphs/KEGG_dendrogram_10.png", dpi=300, bbox_inches="tight")  # Save as PNG
plt.show()
...
# Save figure
plt.savefig("C:/Users/hayat/Downloads/R_files/graphs/KEGG_clustermap_10.png", dpi=300, bbox_inches="tight")  
plt.show()
...
# Save to a CSV file
cluster_groups.to_csv("C:/Users/hayat/Downloads/R_files/data/plasmid_cluster_mapping_KEGG_10.csv", header=True)

print("Plasmid names per cluster saved to 'plasmid_cluster_mapping_KEGG_10.csv'")

# Load the cluster mapping file
cluster_mapping = pd.read_csv(
    "C:/Users/hayat/Downloads/R_files/data/plasmid_cluster_mapping_KEGG_10.csv", 
    index_col=0, 
...
cluster_mapping["Percentage"] = (cluster_mapping["Plasmid_Count"] / total_plasmids) * 10
...
filtered_clusters.to_csv(
    "C:/Users/hayat/Downloads/R_files/data/plasmid_cluster_filtered_KEGG_10.csv", 
    index=True,  
    header=True,  
...
# Save histogram
plt.savefig("C:/Users/hayat/Downloads/R_files/graphs/plasmid_cluster_barplot_KEGG_10.png", dpi=300, bbox_inches="tight")
plt.show()
