...
get_destination <- function(square) {
  ...
  #can be done using case_match and case_when
...
die_rolls_per_game <- numeric(runs)
...
# create the tibble for plotting. as numeric is necessary to get an ordered x axis

results_tibble <- tibble(
  square = as.numeric(names(total_visits[-49])),
