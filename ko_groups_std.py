...
plt.savefig("C:/Users/hayat/Downloads/R_files/graphs/UMAP_DBSCAN_plot_ko_std_py.png", dpi=300, bbox_inches='tight')
plt.show()
...
with open("C:/Users/hayat/Downloads/R_files/data/plasmids_per_cluster_ko_std.txt", "w") as f:
...
plt.savefig("C:/Users/hayat/Downloads/R_files/graphs/UMAP_Host_Color.png", dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig("C:/Users/hayat/Downloads/R_files/graphs/UMAP_Facet_Grid_Host.png", dpi=300, bbox_inches='tight')
plt.show()
