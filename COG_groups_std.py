...
#import umap.plot
# Load data
df = pd.read_csv("C:/Users/hayat/Downloads/R_files/data/COGs_per_plasmid.txt", sep="\t", header=None, names=["Plasmid", "COG"])
...
# Filter COG that appear in at least 10 plasmids
...
# plt.savefig("C:/Users/hayat/Downloads/R_files/graphs/UMAP_HDBSCAN_plot_COG_std.png", dpi=300, bbox_inches='tight')
# plt.show()
...
plt.title("DBSCAN Clustering of UMAP Results according to COG categories")

# Hide legend if too large
plt.legend([], [], frameon=False)

plt.savefig("C:/Users/hayat/Downloads/R_files/graphs/UMAP_DBSCAN_plot_COG_std_py.png", dpi=300, bbox_inches='tight')
plt.show()
...
with open("C:/Users/hayat/Downloads/R_files/data/plasmids_per_cluster_COG_std.txt", "w") as f:
...
plt.savefig("C:/Users/hayat/Downloads/R_files/graphs/UMAP_Host_Color_COG.png", dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig("C:/Users/hayat/Downloads/R_files/graphs/UMAP_Facet_Grid_Host_COG.png", dpi=300, bbox_inches='tight')
plt.show()
